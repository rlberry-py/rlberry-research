...
# from rlberry_research.agents.torch.ppo import PPOAgent
...
def test_ppo():
    ...
    pporlberry_stats = ExperimentManager(
        ...
        init_kwargs=dict(
            batch_size=24,
            n_steps=96,
            policy_net_fn="rlberry_research.agents.torch.utils.training.model_factory_from_env",
            ...
            value_net_fn="rlberry_research.agents.torch.utils.training.model_factory_from_env",
